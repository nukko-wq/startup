						...
						{({ close }) => (
							<>
								...
								<div className="mt-6 flex justify-end gap-2">
									<Button
										onPress={close}
										className="px-4 py-2 bg-slate-200 text-slate-800 rounded-md hover:bg-slate-300 outline-hidden"
									...
									<Button
										...
										className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 outline-hidden flex items-center gap-2"
										isDisabled={isDeleting}
									>
										{isDeleting ? '削除中...' : '削除'}
									</Button>
